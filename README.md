...
![Grav Coder](https://github.com/ParitoshBh/grav-coder/blob/master/assets/screenshot.png)

# Installation

Grav Redoc depends on Grav Coder. So you need to install Grav Coder as well. Install Grav Redoc manually just like that for Grav Coder and change `/yoursite/user/config/system.yaml` to choose `grav-redoc` as default theme.
